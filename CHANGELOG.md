...
- **Keyword Matching False Positives** — Category keywords are now matched longest-first globally, so "Lønoverførsel" correctly categorizes as income rather than being mis-categorized as a transfer.
